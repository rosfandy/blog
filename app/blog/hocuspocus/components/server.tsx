...
export default async function ServerComponent() {
    const post = await fetchPageBySlug("hocuspocus");
    if (!post) notFound();

    // Specify the directory path
    const directory = './public/hocuspocus/';
    ...
    //     fs.writeFileSync(directory + 'hocuspocus-thumbnail.jpg', imageData);
    // } catch (error) {
    //     console.log(error);
    // }
    ...
    fs.writeFileSync(directory + 'hocuspocus.json', JSON.stringify(jsonContent, null, 2));
}
